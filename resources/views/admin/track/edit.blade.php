    ...
    <div class="col-md-8 col-12">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-horizontal" action="{{ route('tracks.update', ["track" => $track->id]) }}" method="POST"
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control" name="name"
                                                placeholder="Track Name" id="first-name-horizontal-icon" value="{{ $track->name }}">
